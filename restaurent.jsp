...
padding: 10px;
	...
	try
	{
		...
		String sql="select * from registration where type='"+typ+"'";
			...
			<div class="row address-row pt-lg-8">
				<div class="container">
					<div class="address-right p-sm-5 p-4 table-responsive">
						...
						<table class="table-responsive" style="cursor: pointer;">
							...
							<tr><td class="td">Phone : <%=contact%></td><td class="td">Catagory : <%=type%></td></tr>
